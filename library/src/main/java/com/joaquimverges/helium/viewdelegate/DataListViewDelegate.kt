 ...
 * @param viewHolderFactory Provides how to create ViewHolders for item views
 ...
 *
 * @see com.joaquimverges.helium.presenter.DataListPresenter
 * @see com.joaquimverges.helium.state.NetworkViewState
 */
open class DataListViewDelegate<T, E : ViewEvent, VH : BaseRecyclerViewItem<T, E>>
constructor(inflater: LayoutInflater,
            viewHolderFactory: (LayoutInflater, ViewGroup) -> VH,
